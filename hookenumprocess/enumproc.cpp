...
BOOL __declspec(dllexport) WINAPI MPEnumProcesses(DWORD *pProcessIds, DWORD cb, DWORD *pBytesReturned)
{
	...
	fprintf(fp_all, "Enumerating Processes \n");
													  ...
													  SIZE_T *lpNumberOfBytesRead)
{
	...
	if(GetProcessImageFileName(hProcess, ImageFileName, 1023))
		fprintf(fp_all, "%d. Reading Process Memory (%d) %ws \n", dwCurrId, dwProcessId, ImageFileName);
	else
		fprintf(fp_all, "%d. Reading Process Memory %d \n", dwCurrId, dwProcessId);
														...
														SIZE_T *lpNumberOfBytesWritten)
{
	...
	if(GetProcessImageFileName(hProcess, ImageFileName, 1023))
		fprintf(fp_all, "%d. Writing Process  Memory (%d) %ws \n", dwCurrId, dwProcessId, ImageFileName);
	else
		fprintf(fp_all, "%d. Writing Process  Memory %d \n", dwCurrId, dwProcessId);
